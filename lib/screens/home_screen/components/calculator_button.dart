...
class _CalculatorButtonState extends ConsumerState<CalculatorButton> {
  ...
  Widget build(BuildContext context) {
    final borderRadius = widget.shape == Shape.circle ? null : BorderRadius.circular(widget.shape == Shape.square ? 20 : 36);
    ...
    return Listener(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          shape: shape,
          color: widget.text == "=" ? Colors.orange.shade500 : kPrimaryColor, // Set the color to orange if the text is "="
          boxShadow: [
            BoxShadow(
